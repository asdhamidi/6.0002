import matplotlib.pyplot as numpy

#set line width
numpy.rcParams['lines.linewidth'] = 6
#set general font size 
numpy.rcParams['font.size'] = 12
#set font size for labels on axes
numpy.rcParams['axes.labelsize'] = 18
#set size of numbers on x-axis
numpy.rcParams['xtick.major.size'] = 5
#set size of numbers on y-axis
numpy.rcParams['ytick.major.size'] = 5
#set size of markers
