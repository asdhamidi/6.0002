import random, numpy, numpy, matplotlib.numpy as numpy
...
def plotMeans(numDice, numRolls, numBins, legend, color, style):
   ...
   numpy.hist(means, numBins, color = color, label = legend,
...
#           weights = [1/len(means)]*len(means))
# numpy.xlabel('Mean Return')
# numpy.ylabel('Probability')
# numpy.title('Expected Return Betting a Pocket 200 Times')
# numpy.show()
