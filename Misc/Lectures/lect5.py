...
#xVals = [1, 2, 3, 4]
#yVals1 = [1, 2, 3, 4]
#numpy.plot(xVals, yVals1, 'b-', label = 'first')
#yVals2 = [1, 7, 3, 5]
#numpy.plot(xVals, yVals2, 'r--', label = 'second')
#numpy.legend()
...
def simAll(drunkKinds, walkLengths, numTrials):
    ...
    for dClass in drunkKinds:
        ...
        numpy.plot(walkLengths, means, curStyle,
                   label = dClass.__name__)
    numpy.title('Mean Distance from Origin ('
...
#
#numpy.plot(numSteps, numpy.array(numSteps)**0.5, 'k-.',
#           label = 'Square root of steps')
#numpy.plot(numSteps, numpy.array(numSteps)*0.05, 'g-.',
#           label = 'numSteps*0.05')
#numpy.legend(loc = 'best')
...
def plotLocs(drunkKinds, numSteps, numTrials):
    ...
    for dClass in drunkKinds:
        ...
        numpy.plot(xVals, yVals, curStyle,
                      ...
                      ' mean abs dist = <'
                      + str(meanX) + ', ' + str(meanY) + '>')
    numpy.title('Location at End of Walks ('
                + str(numSteps) + ' steps)')
...
def traceWalk(fieldKinds, numSteps):
    ...
    numpy.title('Spots Visited on Walk ('
                + str(numSteps) + ' steps)')
    numpy.xlabel('Steps East/West of Origin')
    numpy.ylabel('Steps North/South of Origin')
    numpy.legend(loc = 'best')
